...
namespace FoxyMonitor.Behaviors
{
    public class PeriodicBindingUpdateBehavior : Behavior<DependencyObject>
    {
        ...
        protected override void OnAttached()
        {
            ...
            timerCallback = s =>
            {
                ...
                {
                    //This exception will be thrown when application is shutting down.
                }
            };
    ...
    public class WeakTimer : IDisposable
    {
        ...
        private readonly WeakReference<TimerCallback> weakCallback;
